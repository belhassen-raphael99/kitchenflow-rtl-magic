      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
        ...
        <Card className="border-r-4 border-r-muted">
          ...
          <CardContent className="p-3 sm:p-6 pt-0">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground">לא מחובר לנתונים</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            <div className="flex flex-col items-center justify-center py-8 sm:py-12 text-center">
              ...
              <p className="text-muted-foreground font-medium text-sm sm:text-base">אין אירועים</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 sm:space-y-4 p-4 sm:p-6 pt-0">
            ...
            <div className="flex items-center justify-between p-2.5 sm:p-4 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">מחובר לנתונים</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-2.5 sm:p-4 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">דרוש חיבור לנתונים</p>
                </div>
              </div>
              <Badge variant="secondary" className="text-[10px] sm:text-xs">לא פעיל</Badge>
            </div>
            ...
            <div className="flex items-center justify-between p-2.5 sm:p-4 bg-muted/50 rounded-lg">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-muted rounded-lg flex items-center justify-center">
                  <ChefHat className="w-4 h-4 sm:w-5 sm:h-5 text-muted-foreground" />
                </div>
                <div>
